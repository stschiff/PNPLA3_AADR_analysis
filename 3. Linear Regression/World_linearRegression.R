...
ft_raster_group.africa <- hline(ft_raster_group.africa, i = c(2,6), border = std_border) %>% as_raster()
...
ft_raster_group.america <- hline(ft_raster_group.america, i = c(9,20), border = std_border) %>% as_raster()
...
ft_raster_group.asia <- hline(ft_raster_group.asia, i = c(7,14), border = std_border) %>% as_raster()
...
ft_raster_group.europe <- hline(ft_raster_group.europe, i = c(9,18), border = std_border) %>% as_raster()
...
lm.america.pnpla3 <- ggplot(data = america.pnpla3, aes(date, pnpla3, label = group)) +
  ...
  geom_label_repel(
    ...
    nudge_x       = -6000 - subset(america.pnpla3, date < -3000 & date > -7000)$date,
    segment.size  = 0.2,
    segment.color = "black",
    direction     = "y",
    hjust         = 0,
...
lm.asia.pnpla3 <- ggplot(data = asia.pnpla3, aes(date, pnpla3, label = group)) +
  ...
  geom_label_repel(
    ...
    nudge_x       = -6000 - subset(asia.pnpla3, date < -3000 & date > -7000)$date,
    segment.size  = 0.2,
    segment.color = "black",
    direction     = "y",
    hjust         = 0,

...
# Time Slice 1
# =============================================================================
countries.group.pnpla3 <- c("Botswana, Malawi, South Africa",
                            "Kenya, Tanzania")
...
country.pnpla3.tmp        <- africa.ts.1.pnpla3.country
country.pnpla3.tmp$pnpla3 <- africa.ts.1.pnpla3.country$pnpla3 * africa.ts.1.pnpla3.country$individuals
# group summarization
africa.ts.1.pnpla3.group <- dplyr::group_by(country.pnpla3.tmp, group) %>% summarise(subregion   = max(subregion),
                                                                                     individuals = sum(individuals),
                                                                                     mean.ycoord = mean(mean.ycoord),
                                                                                     mean.xcoord = mean(mean.xcoord),
                                                                                     date        = round(mean(date)),
                                                                                     pnpla3      = sum(pnpla3)/individuals)
africa.ts.1.pnpla3.group <- tibble::add_column(africa.ts.1.pnpla3.group, countries = countries.group.pnpla3, .before = "subregion")
# create group table
group.table.data.ts1.pnpla3        <- dplyr::ungroup(africa.ts.1.pnpla3.group)
...
africa.ts.2.pnpla3.country   <- dplyr::group_by(africa.ts.2.pnpla3, country) %>% summarise(individuals = n(),
                                                                                           ...
                                                                                           pnpla3      = compute.allele.freq(pnpla3))
# weighting for group allele frequencies
country.pnpla3.tmp        <- africa.ts.2.pnpla3.country
country.pnpla3.tmp$pnpla3 <- africa.ts.2.pnpla3.country$pnpla3 * africa.ts.2.pnpla3.country$individuals
# group summarization
africa.ts.2.pnpla3.group <- dplyr::group_by(country.pnpla3.tmp, group) %>% summarise(subregion   = max(subregion),
                                                                                     individuals = sum(individuals),
                                                                                     mean.ycoord = mean(mean.ycoord),
                                                                                     mean.xcoord = mean(mean.xcoord),
                                                                                     date        = round(mean(date)),
                                                                                     pnpla3      = sum(pnpla3)/individuals)
africa.ts.2.pnpla3.group <- tibble::add_column(africa.ts.2.pnpla3.group, countries = countries.group.pnpla3, .before = "subregion")
# create group table
group.table.data.ts2.pnpla3        <- dplyr::ungroup(africa.ts.2.pnpla3.group)
...
africa.ts.3.pnpla3.country   <- dplyr::group_by(africa.ts.3.pnpla3, country) %>% summarise(individuals = n(),
                                                                                           ...
                                                                                           pnpla3      = compute.allele.freq(pnpla3))
# weighting for group allele frequencies
country.pnpla3.tmp        <- africa.ts.3.pnpla3.country
country.pnpla3.tmp$pnpla3 <- africa.ts.3.pnpla3.country$pnpla3 * africa.ts.3.pnpla3.country$individuals
# group summarization
africa.ts.3.pnpla3.group <- dplyr::group_by(country.pnpla3.tmp, group) %>% summarise(subregion   = max(subregion),
                                                                                     individuals = sum(individuals),
                                                                                     mean.ycoord = mean(mean.ycoord),
                                                                                     mean.xcoord = mean(mean.xcoord),
                                                                                     date        = round(mean(date)),
                                                                                     pnpla3      = sum(pnpla3)/individuals)
africa.ts.3.pnpla3.group <- tibble::add_column(africa.ts.3.pnpla3.group, countries = countries.group.pnpla3, .before = "subregion")
# create group kable table
group.table.data.ts3.pnpla3        <- dplyr::ungroup(africa.ts.3.pnpla3.group)
...
# =============================================================================
# time slice 1
write.csv(group.table.data.ts1.pnpla3, "2. Time Slices/1. Data/africa_timeSlice1_group_table_data_pnpla3.csv")
# time slice 2
write.csv(group.table.data.ts2.pnpla3, "2. Time Slices/1. Data/africa_timeSlice2_group_table_data_pnpla3.csv")
# time slice 3
write.csv(group.table.data.ts3.pnpla3, "2. Time Slices/1. Data/africa_timeSlice3_group_table_data_pnpla3.csv")
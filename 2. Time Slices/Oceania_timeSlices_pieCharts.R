...
oceania.ts.2 <- dplyr::filter(individuals.data, individuals.data$date > 3000 & individuals.data$date <= 7000) %>% filter(continent == "Oceania") %>% select(c(1:11))
# exclude individuals with no allele information
oceania.ts.1.pnpla3 <- dplyr::filter(oceania.ts.1, oceania.ts.1$pnpla3 != 9)
oceania.ts.2.pnpla3 <- dplyr::filter(oceania.ts.2, oceania.ts.2$pnpla3 != 9)
...
# =============================================================================
# ind -> country summarization
oceania.ts.2.pnpla3$subregion <- as.character(oceania.ts.2.pnpla3$subregion)
oceania.ts.2.pnpla3.country   <- dplyr::group_by(oceania.ts.2.pnpla3, country) %>% summarise(individuals = n(),
                                                                                             subregion   = max(subregion),
                                                                                             mean.ycoord = mean(ycoord),
                                                                                             mean.xcoord = mean(xcoord),
                                                                                             date        = mean(date),
                                                                                             ...
                                                                                             pnpla3      = compute.allele.freq(pnpla3))
# weighting for group allele frequencies
oceania.ts.2.pnpla3.country$pnpla3 <- oceania.ts.2.pnpla3.country$pnpla3 * oceania.ts.2.pnpla3.country$individuals
# group summarization
oceania.ts.2.pnpla3.group <- dplyr::group_by(oceania.ts.2.pnpla3.country, group) %>% summarise(subregion   = max(subregion),
                                                                                               individuals = sum(individuals),
                                                                                               mean.ycoord = mean(mean.ycoord),
                                                                                               mean.xcoord = mean(mean.xcoord),
                                                                                               date        = mean(date),
                                                                                               pnpla3      = sum(pnpla3)/individuals)
# preparing for pie charts
oceania.ts.2.pnpla3.group.pc <- pie.chart.preparation(oceania.ts.2.pnpla3.group, "pnpla3")
...
# time slice 2
data.table::setnames(oceania.ts.2.pnpla3.group.pc, "minor", "pnpla3")
write.csv(oceania.ts.2.pnpla3.group.pc, "2. Time Slices/1. Data/oceania_timeSlice2_pnpla3.csv")